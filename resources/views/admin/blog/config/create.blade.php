...
@section('content')
    <div class="pageheader">
        ...
        {!! Breadcrumbs::render('admin-blog-config-create') !!}
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('admin.blog.config.store') }}" method="POST">
                        ...
                        <div class="panel-body panel-body-nopadding">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="value" maxlength="200" class="form-control" rows="5">{{ old('value') }}</textarea>
                                </div>
                            </div>
