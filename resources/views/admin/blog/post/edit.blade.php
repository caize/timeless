...
@section('content')
    <div class="pageheader">
        ...
        {!! Breadcrumbs::render('admin-blog-post-edit') !!}
    </div>
            ...
            <div class="col-sm-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered"
                          action="{{ route('admin.blog.post.update',['id'=>$post->pid]) }}" method="POST">
                        ...
                        <div class="panel-body panel-body-nopadding">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="title"
                                           ...
                                           data-original-title="必填项" value="{{ $post->title }}" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="slug"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="多个英文数字以-相连" value="{{ $post->slug }}" 
                                           required="required" maxlength="100">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control input-sm" name="type">
                                        <option value="post" {{ $post->type == 'post' ? 'selected' : '' }}>文章</option>
                                        <option value="page" {{ $post->type == 'page' ? 'selected' : '' }}>页面</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    name="classes[]" multiple data-placeholder="选择分类">
                                        ...
                                        {!! $blogMetasPresenter->classesSelect($hasClasses) !!}
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="source"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="若是转载文章，此处填写出处" value="{{ $post->source }}" 
                                           maxlength="20">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="source_url"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="转载文章的链接地址" value="{{ $post->source_url }}" 
                                           maxlength="100">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="summary" maxlength="500" class="form-control" rows="5">{{ $post->summary }}</textarea>
                                </div>
                            </div> 
