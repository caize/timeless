...
*/
    'core' => [
        ...
        'middleware' => 'auth.admin',    //解决权限验证的问题，会在控制器的构造函数中调用

        'mode'=>'qiniu',//上传方式,local 为本地   qiniu 为七牛

        //七牛配置,若mode='qiniu',以下为必填.
        'qiniu'=>[
            'accessKey'=>'7U08861ZkRsDfAQg-HtkMGrTUQUzIc82IZ59pcHZ',
            'secretKey'=>'-YFMUss5Ykqo4ht0nL-Df6oD0hY9E1wvj0dH4Dc9',
            'bucket'=>'justfantasy',
            'url'=>'http://7xt6kw.com1.z0.glb.clouddn.com',//七牛分配的CDN域名,注意带上http://
