...
(21, 20, '', 'admin.admin_user.index', '用户管理', '查看后台用户列表', 1, 0, '2016-04-06 12:33:42', '2016-04-06 04:33:42'),
...
(44, 20, '', 'admin.permission.index', '权限管理', '页面', 1, 0, '2016-04-06 12:33:17', '2016-04-06 04:33:17'),
...
(51, 20, '', 'admin.role.index', '角色管理', '页面', 1, 0, '2016-04-06 12:32:42', '2016-04-06 04:32:42'),
...
CREATE TABLE IF NOT EXISTS `blog_posts` (
  ...
  `slug` varchar(200) NOT NULL DEFAULT '' COMMENT 'SEO标题',
  `content` text NOT NULL DEFAULT '' COMMENT '文章内容',
  `type` varchar(10) NOT NULL DEFAULT 'post' COMMENT '类型：post文章 page页面',
  `source` VARCHAR(20) NOT NULL DEFAULT '' COMMENT '来源',
  `source_url` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '来源url',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  UNIQUE KEY `blog_posts_slug_index` (`slug`)
...
CREATE TABLE IF NOT EXISTS `blog_metas` (
  ...
  `slug` VARCHAR(100) NOT NULL DEFAULT '' COMMENT 'SEO名称',
  `type` VARCHAR(30) NOT NULL DEFAULT 'class' COMMENT '类型：class分类 tag标签',
  `desc` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '描述',
  `order` INT(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  `parent` INT(10) unsigned NOT NULL DEFAULT '0' COMMENT '父id',
  UNIQUE KEY `blog_metas_slug_type_index` (`slug`, `type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT '分类和标签表';
...
CREATE TABLE IF NOT EXISTS `blog_mappings` (
  `pid` INT(10) unsigned NOT NULL DEFAULT '0',
  `mid` INT(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`pid`, `mid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT '文章和标签的映射关系表';
...
CREATE TABLE IF NOT EXISTS `blog_configs` (
  ...
  `value` VARCHAR(200) NOT NULL DEFAULT '' COMMENT '字段值',
  `desc` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '描述',
  UNIQUE KEY `blog_configs_name_index` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT '配置文件表';

ALTER TABLE `blog_posts` ADD COLUMN `summary` VARCHAR(1000) NOT NULL DEFAULT '' COMMENT '摘要' AFTER `slug`; 
